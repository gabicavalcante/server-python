...
class Server:
    ...
    def _doing_connections(self):
        ...
        while True:
            ...
            if method == 'GET':
                args = request_string.split(' ')[1]  # take the required file and arguments

                if len(args.split("?")) > 1:
                    required_file = args.split("?")[0] + '/' + self._args_handler_cgi(args.split("?")[1])
                else:
                    required_file = args
                ...
                required_file = self.http_root + required_file
                ...
                print "unknown HTTP request method: {0}".format(method)

    def _args_handler(self, args):
        """
    ...
    def _args_handler_cgi(self, args):
        """
